...
<div class="right_col" role="main">
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>MANAGEMENT FOTO DESTINASI</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Form Tambah Data Foto Destinasi</h2>
                                ...
                                <div class="x_content">
                                <form name="sentMessage" method="post" action="<?php echo site_url('fodes/save');?>" enctype="multipart/form-data">
    ...
    <?php foreach($destinasi as $val){ ?>
        <option value="<?php echo $val->id_wisata;?>"><?php echo $val->id_wisata;?> - <?php echo $val->namawisata;?></option>
    <?php }?>
</select>
